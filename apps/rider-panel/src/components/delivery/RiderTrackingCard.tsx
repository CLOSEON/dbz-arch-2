...
const getRiderIcon = () => createSvgIcon(
  `<div style="
...
const getDestIcon = () => createSvgIcon(
  `<div style="
          ...
          >
            <div className="relative">
              ...
              >
                ...
                <Marker position={[driverLocation.lat, driverLocation.lng]} icon={getRiderIcon()}>
                ...
                {destLocation && typeof destLocation.lat === 'number' && typeof destLocation.lng === 'number' && destLocation.lat !== 0 && destLocation.lng !== 0 && (
                  <Marker position={[destLocation.lat, destLocation.lng]} icon={getDestIcon()}>
