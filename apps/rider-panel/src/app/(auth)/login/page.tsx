        ...
        <div className="w-full max-w-md mx-auto flex-1 flex flex-col justify-center">
          ...
          <div className="flex flex-col items-center mb-10 animate-fade-in text-center">
            ...
            <p className="text-base font-medium text-slate-500">
              {step === 'phone'
                ? 'Delivery Fleet & Smart Logistics'
                : step === 'otp'
                ? 'Verify your number'
          ...
          {step === 'phone' && (
            <form onSubmit={handleSendOTP} className="w-full space-y-6 animate-fade-in">
              <div className="relative">
                ...
                <div className="flex items-center bg-white border-2 border-slate-100 rounded-2xl px-4 py-3.5 focus-within:border-emerald-500 focus-within:shadow-[0_0_0_4px_rgba(16,185,129,0.1)] transition-all duration-300 shadow-sm">
              ...
              <button
                ...
                className="w-full bg-emerald-600 text-white font-bold text-lg py-[18px] rounded-2xl transition-all active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg shadow-emerald-600/25 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-emerald-700"
              >
                {loading ? (
            ...
            <form onSubmit={handleVerifyOTP} className="w-full space-y-6 animate-fade-in">
              ...
              <div className="relative">
                <input
                  ...
                  inputMode="numeric"
                  placeholder="------"
                  className="w-full text-center text-[40px] font-bold py-5 bg-white border-2 border-slate-100 rounded-2xl outline-none focus:border-emerald-500 focus:shadow-[0_0_0_4px_rgba(16,185,129,0.1)] transition-all duration-300 tracking-[0.4em] text-slate-900 shadow-sm"
                  value={otp}
              ...
              <div className="flex items-center justify-center gap-6 pt-2">
                ...
                <button
                  ...
                  className="text-sm font-bold text-emerald-600 hover:text-emerald-700 transition-colors disabled:text-slate-300"
                >
            ...
            <form onSubmit={handleOnboarding} className="w-full space-y-5 animate-fade-in">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-white border-2 border-slate-100 rounded-2xl px-5 py-4 text-lg font-bold outline-none focus:border-emerald-500 focus:shadow-[0_0_0_4px_rgba(16,185,129,0.1)] transition-all duration-300 text-slate-900 shadow-sm placeholder:text-slate-300"
                  value={name}
              ...
              <button
                ...
                className="w-full bg-emerald-600 text-white font-bold text-lg py-[18px] rounded-2xl transition-all active:scale-[0.98] flex items-center justify-center mt-6 shadow-lg shadow-emerald-600/25 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-emerald-700"
              >
                {loading ? (
                  <div className="w-6 h-6 rounded-full border-2 border-white/30 border-t-white animate-spin" />
                ) : (
