...
`;a.s(["CheckmarkIcon",0,Q,"ErrorIcon",0,L,"LoaderIcon",0,N,"ToastBar",0,Y,"ToastIcon",0,V,"Toaster",0,({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))},"default",0,F,"resolveValue",0,s,"toast",0,F,"useToaster",0,H,"useToasterStore",0,D],96483)},45095,a=>{"use strict";a.i(31263);var b=a.i(50711),c=a.i(8621),d=a.i(28784),e=a.i(14570);async function f(a,d){let f=`${a}_${d}`,g=await (0,c.getDoc)((0,b.doc)(e.db,"daily_menus",f));return g.exists()?{id:g.id,...g.data()}:null}async function g(a,f,g){let h=`${a}_${f}`;await (0,c.setDoc)((0,b.doc)(e.db,"daily_menus",h),{...g,vendor_id:a,date:f,updated_at:d.Timestamp.now()},{merge:!0})}a.s(["getDailyMenu",0,f,"getTodayStr",0,function(){let a=new Date;return`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`},"saveDailyMenu",0,g])},77861,a=>{"use strict";var b,c,d,e;(d=b||(b={})).Heavy="HEAVY",d.Medium="MEDIUM",d.Light="LIGHT",(e=c||(c={})).Success="SUCCESS",e.Warning="WARNING",e.Error="ERROR",a.s(["ImpactStyle",0,b,"NotificationType",0,c])},70850,a=>{"use strict";var b=a.i(38996),c=a.i(77861);let d=(0,b.registerPlugin)("Haptics",{web:()=>a.A(34558).then(a=>new a.HapticsWeb)});var e=c;let f=b.Capacitor.isNativePlatform(),g=async(a=e.ImpactStyle.Medium)=>{if(f)try{await d.impact({style:a})}catch(a){console.warn("[Haptics] Failed to trigger impact:",a)}},h=async(a=e.NotificationType.Success)=>{if(f)try{await d.notification({type:a})}catch(a){console.warn("[Haptics] Failed to trigger notification:",a)}},i=async()=>{if(f)try{await d.selectionStart(),setTimeout(async()=>{await d.selectionEnd()},50)}catch(a){console.warn("[Haptics] Failed to trigger selection:",a)}};a.s(["triggerHapticImpact",0,g,"triggerHapticNotification",0,h,"triggerHapticSelection",0,i],70850)},76048,a=>{"use strict";var b=a.i(31185),c=a.i(35517),d=a.i(67373);a.i(31263);var e=a.i(22440),f=a.i(8621),g=a.i(14570),h=a.i(45095),i=a.i(42092);let j=(0,c.createContext)(void 0);a.s(["VendorDataProvider",0,function({children:a}){let k=(0,d.useAuthStore)(a=>a.user),[l,m]=(0,c.useState)([]),[n,o]=(0,c.useState)([]),[p,q]=(0,c.useState)([]),[r,s]=(0,c.useState)([]),[t,u]=(0,c.useState)(null),[v,w]=(0,c.useState)(!0),[x,y]=(0,c.useState)(null);return(0,c.useEffect)(()=>{let a,b,c,d,j;if(!k?.id||"vendor"!==k.role)return void w(!1);w(!0);try{let l=(0,f.query)((0,e.collection)(g.db,"batches"),(0,f.where)("vendor_id","==",k.id),(0,f.where)("status","in",["pending","preparing","ready","notified"]));a=(0,f.onSnapshot)(l,a=>{m(a.docs.map(a=>({id:a.id,...a.data()})))},a=>{console.error("Batches listener error:",a),y(a)});let n=(0,f.query)((0,e.collection)(g.db,"rider_trips"),(0,f.where)("vendorIds","array-contains",k.id),(0,f.where)("status","in",["assigned","accepted","at_vendor","pickup_pending","picking_up"]));b=(0,f.onSnapshot)(n,async a=>{let b=a.docs.map(a=>({id:a.id,...a.data()})),c=Array.from(new Set(b.map(a=>a.riderId))).filter(Boolean),d=await (0,i.fetchEnrichedProfiles)(c),e=b.map(a=>{let b=d.get(a.riderId);return{...a,riderName:b?.name||"Rider",riderPhone:b?.phone_number||b?.phone||""}});o(e)},a=>console.error("Pickups listener error:",a));let p=(0,f.query)((0,e.collection)(g.db,"deliveries"),(0,f.where)("vendor_id","==",k.id),(0,f.where)("status","in",["out_for_delivery","picked_up"]));c=(0,f.onSnapshot)(p,a=>{q(a.docs.map(a=>({id:a.id,...a.data()})))},a=>console.error("Deliveries listener error:",a));let r=(0,f.query)((0,e.collection)(g.db,"subscriptions"),(0,f.where)("vendor_id","==",k.id),(0,f.where)("status","==","active"));d=(0,f.onSnapshot)(r,async a=>{let b=a.docs.map(a=>({id:a.id,...a.data()})),c=Array.from(new Set(b.map(a=>a.user_id))).filter(Boolean),d=await (0,i.fetchEnrichedProfiles)(c),e=b.map(a=>{let b=d.get(a.user_id);return{...a,userName:b?.name||"Unknown",userPhone:b?.phone||""}});s(e)},a=>console.error("Subscriptions listener error:",a));let t=(0,h.getTodayStr)(),v=(0,f.query)((0,e.collection)(g.db,"daily_menus"),(0,f.where)("vendor_id","==",k.id),(0,f.where)("date","==",t));j=(0,f.onSnapshot)(v,a=>{a.empty?u(null):u({id:a.docs[0].id,...a.docs[0].data()})},a=>console.error("Menu listener error:",a)),w(!1)}catch(a){y(a),w(!1)}return()=>{a&&a(),b&&b(),c&&c(),d&&d(),j&&j()}},[k?.id,k?.role]),(0,b.jsx)(j.Provider,{value:{batches:l,pickups:n,deliveries:p,subscriptions:r,dailyMenu:t,loading:v,error:x},children:a})},"useVendorData",0,function(){let a=(0,c.useContext)(j);if(void 0===a)throw Error("useVendorData must be used within a VendorDataProvider");return a}])}];

//# sourceMappingURL=Desktop_CLOSEON_applications_Webapp_DBZARCH2_0vutp6a._.js.map