      ...
      <div className="px-2">
        {!isOnline ? (
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-1 shadow-2xl backdrop-blur-xl">
            <div className="bg-indigo-950/40 rounded-t-[22px] p-6 text-center border-b border-slate-100">
              <span className="inline-block px-3 py-1 bg-indigo-500/20 text-indigo-600 text-[10px] font-black uppercase tracking-widest rounded-full mb-4">
                Pickup Requested
              </span>
              ...
              <p className="text-slate-500 font-medium text-sm flex items-center justify-center gap-1">
                <Navigation size={14} className="text-indigo-600" /> {(nextPickup.distanceKm ?? 0).toFixed(1)} km away
              </p>
            </div>
